...
public class RabbitMQProducer : IServiceBusProducer
{
    ...
    public RabbitMQProducer(IOptions<EventBusConfiguration> eventBusConfiguration)
    {
    ...
    public void Publish(object payload, IEventRoute evenRoute)
    {
        ...
        channel.QueueDeclare(queue: evenRoute.QueueName, durable: evenRoute.Durable, autoDelete: false, arguments: null);

        channel.QueueBind(queue: evenRoute.QueueName, exchange: evenRoute.Exchange, routingKey: evenRoute.RoutingKey, arguments: null);
